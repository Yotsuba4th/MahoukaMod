...
public class EntityMagicProjectileEarth extends EntityMagicProjectile
{

    public EntityMagicProjectileEarth(World world)
    {
        super(world);
        setSize(0.5f, 0.5f);
    }

    public EntityMagicProjectileEarth(World world, EntityLivingBase shooter, double x, double y, double z)
    {
